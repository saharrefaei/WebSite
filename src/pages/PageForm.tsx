...
import { TextField, IconClick } from "../assets/styles/styledMaterial";
...
export default function PageForm(props: any) {
  ...
  const TextFieldCustom = ({ reg, label, type = "text" }) => (
    <TextField
      {...register(reg)}
      autoComplete="off"
      type={type}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <DateTimePicker
            ...
            renderInput={(params) => (
              <TextField {...params} style={{ margin: "0.75em 0" }} />
            )}
          />
          <DateTimePicker
            value={dateEnd}
        ...
        <Button onClick={() => navigate("/500-Error")} type="submit">
          SEND TO SERVER
        </Button>
      </form>
